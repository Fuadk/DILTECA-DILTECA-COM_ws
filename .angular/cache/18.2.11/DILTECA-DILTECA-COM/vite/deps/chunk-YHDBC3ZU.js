...
var DateInput = (
  ...
  function(_super) {
    ...
    DateInput2.prototype.modifyDateSegmentValue = function(offset, symbol, event2) {
      if (symbol === void 0) {
        symbol = "";
      }
      if (event2 === void 0) {
...
CenturyViewService.ɵfac = function CenturyViewService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || CenturyViewService)();
};
...
DecadeViewService.ɵfac = function DecadeViewService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DecadeViewService)();
};
...
MonthViewService.ɵfac = function MonthViewService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MonthViewService)(ɵɵinject(IntlService));
};
...
YearViewService.ɵfac = function YearViewService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || YearViewService)(ɵɵinject(IntlService));
};
...
BusViewService.ɵfac = function BusViewService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || BusViewService)(ɵɵinject(Injector));
};
...
KForOf.ɵfac = function KForOf_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || KForOf)(ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(TemplateRef), ɵɵdirectiveInject(IterableDiffers));
};
...
DisabledDatesService.ɵfac = function DisabledDatesService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DisabledDatesService)();
};
...
ViewComponent.ɵfac = function ViewComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ViewComponent)(ɵɵdirectiveInject(BusViewService), ɵɵdirectiveInject(IntlService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(DisabledDatesService));
};
...
HorizontalViewListComponent.ɵfac = function HorizontalViewListComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || HorizontalViewListComponent)(ɵɵdirectiveInject(BusViewService), ɵɵdirectiveInject(IntlService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2));
};
...
HeaderComponent.ɵfac = function HeaderComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || HeaderComponent)(ɵɵdirectiveInject(BusViewService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(LocalizationService), ɵɵdirectiveInject(IntlService), ɵɵdirectiveInject(DisabledDatesService));
};
...
SelectionService.ɵfac = function SelectionService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SelectionService)(ɵɵinject(BusViewService));
};
...
CellTemplateDirective.ɵfac = function CellTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || CellTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
...
MonthCellTemplateDirective.ɵfac = function MonthCellTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MonthCellTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
...
YearCellTemplateDirective.ɵfac = function YearCellTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || YearCellTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
...
DecadeCellTemplateDirective.ɵfac = function DecadeCellTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DecadeCellTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
...
CenturyCellTemplateDirective.ɵfac = function CenturyCellTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || CenturyCellTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
...
WeekNumberCellTemplateDirective.ɵfac = function WeekNumberCellTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || WeekNumberCellTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
...
HeaderTitleTemplateDirective.ɵfac = function HeaderTitleTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || HeaderTitleTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
...
NavigationService.ɵfac = function NavigationService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NavigationService)(ɵɵinject(BusViewService));
};
...
FooterComponent.ɵfac = function FooterComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || FooterComponent)(ɵɵdirectiveInject(IntlService));
};
...
MultiViewCalendarLocalizedMessagesDirective.ɵfac = function MultiViewCalendarLocalizedMessagesDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MultiViewCalendarLocalizedMessagesDirective)(ɵɵdirectiveInject(LocalizationService));
};
...
MultiViewCalendarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    ...
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_0 = goog.getMsg("Today");
      i18n_0 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_0;
    } else {
      i18n_0 = $localize`:kendo.multiviewcalendar.today|The label for the today button in the calendar header:Today`;
    }
    let i18n_1;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_1 = goog.getMsg("Navigate to previous view");
      i18n_1 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_1;
    } else {
    ...
    let i18n_2;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_2 = goog.getMsg("Navigate to next view");
      i18n_2 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_2;
    } else {
    ...
    let i18n_3;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_3 = goog.getMsg("Navigate to parent view");
      i18n_3 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_3;
    } else {
...
CalendarDOMService.ɵfac = function CalendarDOMService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || CalendarDOMService)();
};
...
VirtualizationComponent.ɵfac = function VirtualizationComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || VirtualizationComponent)(ɵɵdirectiveInject(SCROLLER_FACTORY_TOKEN), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ScrollbarWidthService));
};
...
NavigationComponent.ɵfac = function NavigationComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NavigationComponent)(ɵɵdirectiveInject(BusViewService), ɵɵdirectiveInject(CalendarDOMService), ɵɵdirectiveInject(IntlService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Renderer2));
};
...
ViewListComponent.ɵfac = function ViewListComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ViewListComponent)(ɵɵdirectiveInject(BusViewService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(IntlService), ɵɵdirectiveInject(CalendarDOMService), ɵɵdirectiveInject(Renderer2));
};
...
ScrollSyncService.ɵfac = function ScrollSyncService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || ScrollSyncService)(ɵɵinject(CalendarDOMService), ɵɵinject(NgZone));
};
...
NavigationItemTemplateDirective.ɵfac = function NavigationItemTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || NavigationItemTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
...
MultiViewCalendarCustomMessagesComponent.ɵfac = function MultiViewCalendarCustomMessagesComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MultiViewCalendarCustomMessagesComponent)(ɵɵdirectiveInject(LocalizationService));
};
...
CalendarMessages.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function CalendarMessages_Factory(__ngFactoryType__) {
    return (ɵCalendarMessages_BaseFactory || (ɵCalendarMessages_BaseFactory = ɵɵgetInheritedFactory(CalendarMessages)))(__ngFactoryType__ || CalendarMessages);
  };
})();
...
CalendarLocalizedMessagesDirective.ɵfac = function CalendarLocalizedMessagesDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || CalendarLocalizedMessagesDirective)(ɵɵdirectiveInject(LocalizationService));
};
...
CalendarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_4;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_4 = goog.getMsg("Today");
      i18n_4 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_4;
    } else {
      i18n_4 = $localize`:kendo.calendar.today|The label for the today button in the calendar header:Today`;
    }
    let i18n_5;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_5 = goog.getMsg("Navigate to previous view");
      i18n_5 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_5;
    } else {
    ...
    let i18n_6;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_6 = goog.getMsg("Navigate to next view");
      i18n_6 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_6;
    } else {
    ...
    let i18n_7;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_7 = goog.getMsg("Navigate to parent view");
      i18n_7 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_7;
    } else {
...
DateInputMessages.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function DateInputMessages_Factory(__ngFactoryType__) {
    return (ɵDateInputMessages_BaseFactory || (ɵDateInputMessages_BaseFactory = ɵɵgetInheritedFactory(DateInputMessages)))(__ngFactoryType__ || DateInputMessages);
  };
})();
...
DateInputLocalizedMessagesDirective.ɵfac = function DateInputLocalizedMessagesDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateInputLocalizedMessagesDirective)(ɵɵdirectiveInject(LocalizationService));
};
...
DateInputComponent.ɵfac = function DateInputComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateInputComponent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(IntlService), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(LocalizationService), ɵɵdirectiveInject(PickerService, 8));
};
DateInputComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_8;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_8 = goog.getMsg("Increase value");
      i18n_8 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_8;
    } else {
      i18n_8 = $localize`:kendo.dateinput.increment|The label for the **Increment** button in the DateInput:Increase value`;
    }
    let i18n_9;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_9 = goog.getMsg("Decrease value");
      i18n_9 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_9;
    } else {
      i18n_9 = $localize`:kendo.dateinput.decrement|The label for the **Decrement** button in the DateInput:Decrease value`;
    }
    let i18n_10;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_10 = goog.getMsg("clear");
      i18n_10 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_10;
    } else {
...
CalendarCustomMessagesComponent.ɵfac = function CalendarCustomMessagesComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || CalendarCustomMessagesComponent)(ɵɵdirectiveInject(LocalizationService));
};
...
DateInputCustomMessagesComponent.ɵfac = function DateInputCustomMessagesComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateInputCustomMessagesComponent)(ɵɵdirectiveInject(LocalizationService));
};
...
DatePickerMessages.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function DatePickerMessages_Factory(__ngFactoryType__) {
    return (ɵDatePickerMessages_BaseFactory || (ɵDatePickerMessages_BaseFactory = ɵɵgetInheritedFactory(DatePickerMessages)))(__ngFactoryType__ || DatePickerMessages);
  };
})();
...
DatePickerLocalizedMessagesDirective.ɵfac = function DatePickerLocalizedMessagesDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DatePickerLocalizedMessagesDirective)(ɵɵdirectiveInject(LocalizationService));
};
...
DatePickerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_11;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_11 = goog.getMsg("Today");
      i18n_11 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_11;
    } else {
      i18n_11 = $localize`:kendo.datepicker.today|The label for the today button in the calendar header:Today`;
    }
    let i18n_12;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_12 = goog.getMsg("Toggle calendar");
      i18n_12 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_12;
    } else {
      i18n_12 = $localize`:kendo.datepicker.toggle|The title of the toggle button in the datepicker component:Toggle calendar`;
    }
    let i18n_13;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_13 = goog.getMsg("Navigate to previous view");
      i18n_13 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_13;
    } else {
    ...
    let i18n_14;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_14 = goog.getMsg("Navigate to next view");
      i18n_14 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_14;
    } else {
    ...
    let i18n_15;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_15 = goog.getMsg("Navigate to parent view");
      i18n_15 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_15;
    } else {
    ...
    let i18n_16;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_16 = goog.getMsg("clear");
      i18n_16 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_16;
    } else {
...
TimePickerDOMService.ɵfac = function TimePickerDOMService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TimePickerDOMService)();
};
...
HoursService.ɵfac = function HoursService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || HoursService)(ɵɵinject(IntlService));
};
...
MinutesService.ɵfac = function MinutesService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MinutesService)(ɵɵinject(IntlService));
};
...
SecondsService.ɵfac = function SecondsService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SecondsService)(ɵɵinject(IntlService));
};
...
MillisecondsService.ɵfac = function MillisecondsService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MillisecondsService)(ɵɵinject(IntlService));
};
...
DayPeriodService.ɵfac = function DayPeriodService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DayPeriodService)(ɵɵinject(IntlService));
};
...
TimeListComponent.ɵfac = function TimeListComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TimeListComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Injector), ɵɵdirectiveInject(TimePickerDOMService), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(LocalizationService));
};
...
TimePickerMessages.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function TimePickerMessages_Factory(__ngFactoryType__) {
    return (ɵTimePickerMessages_BaseFactory || (ɵTimePickerMessages_BaseFactory = ɵɵgetInheritedFactory(TimePickerMessages)))(__ngFactoryType__ || TimePickerMessages);
  };
})();
...
TimeSelectorLocalizedMessagesDirective.ɵfac = function TimeSelectorLocalizedMessagesDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TimeSelectorLocalizedMessagesDirective)(ɵɵdirectiveInject(LocalizationService));
};
...
TimeSelectorComponent.ɵfac = function TimeSelectorComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TimeSelectorComponent)(ɵɵdirectiveInject(LocalizationService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(IntlService), ɵɵdirectiveInject(TimePickerDOMService), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(PickerService, 8));
};
TimeSelectorComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_17;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_17 = goog.getMsg("Set");
      i18n_17 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_17;
    } else {
      i18n_17 = $localize`:kendo.timeselector.accept|The Accept button text in the timeselector component:Set`;
    }
    let i18n_18;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_18 = goog.getMsg("Set time");
      i18n_18 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_18;
    } else {
      i18n_18 = $localize`:kendo.timeselector.acceptLabel|The label for the Accept button in the timeselector component:Set time`;
    }
    let i18n_19;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_19 = goog.getMsg("Cancel");
      i18n_19 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_19;
    } else {
      i18n_19 = $localize`:kendo.timeselector.cancel|The Cancel button text in the timeselector component:Cancel`;
    }
    let i18n_20;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_20 = goog.getMsg("Cancel changes");
      i18n_20 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_20;
    } else {
    ...
    let i18n_21;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_21 = goog.getMsg("Now");
      i18n_21 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_21;
    } else {
      i18n_21 = $localize`:kendo.timeselector.now|The Now button text in the timeselector component:Now`;
    }
    let i18n_22;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_22 = goog.getMsg("Select now");
      i18n_22 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_22;
    } else {
...
TimeSelectorCustomMessagesComponent.ɵfac = function TimeSelectorCustomMessagesComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TimeSelectorCustomMessagesComponent)(ɵɵdirectiveInject(LocalizationService));
};
...
TimePickerLocalizedMessagesDirective.ɵfac = function TimePickerLocalizedMessagesDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TimePickerLocalizedMessagesDirective)(ɵɵdirectiveInject(LocalizationService));
};
...
TimePickerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_23;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_23 = goog.getMsg("Set");
      i18n_23 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_23;
    } else {
      i18n_23 = $localize`:kendo.timepicker.accept|The Accept button text in the timepicker component:Set`;
    }
    let i18n_24;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_24 = goog.getMsg("Set time");
      i18n_24 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_24;
    } else {
      i18n_24 = $localize`:kendo.timepicker.acceptLabel|The label for the Accept button in the timepicker component:Set time`;
    }
    let i18n_25;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_25 = goog.getMsg("Cancel");
      i18n_25 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_25;
    } else {
      i18n_25 = $localize`:kendo.timepicker.cancel|The Cancel button text in the timepicker component:Cancel`;
    }
    let i18n_26;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_26 = goog.getMsg("Cancel changes");
      i18n_26 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_26;
    } else {
      i18n_26 = $localize`:kendo.timepicker.cancelLabel|The label for the Cancel button in the timepicker component:Cancel changes`;
    }
    let i18n_27;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_27 = goog.getMsg("Now");
      i18n_27 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_27;
    } else {
      i18n_27 = $localize`:kendo.timepicker.now|The Now button text in the timepicker component:Now`;
    }
    let i18n_28;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_28 = goog.getMsg("Select now");
      i18n_28 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_28;
    } else {
      i18n_28 = $localize`:kendo.timepicker.nowLabel|The label for the Now button in the timepicker component:Select now`;
    }
    let i18n_29;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_29 = goog.getMsg("Toggle time list");
      i18n_29 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_29;
    } else {
      i18n_29 = $localize`:kendo.timepicker.toggle|The label for the toggle button in the timepicker component:Toggle time list`;
    }
    let i18n_30;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_30 = goog.getMsg("Hour");
      i18n_30 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_30;
    } else {
      i18n_30 = $localize`:kendo.timepicker.hour|The label for the hour part in the timepicker component:Hour`;
    }
    let i18n_31;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_31 = goog.getMsg("Minute");
      i18n_31 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_31;
    } else {
      i18n_31 = $localize`:kendo.timepicker.minute|The label for the minute part in the timepicker component:Minute`;
    }
    let i18n_32;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_32 = goog.getMsg("Second");
      i18n_32 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_32;
    } else {
      i18n_32 = $localize`:kendo.timepicker.second|The label for the second part in the timepicker component:Second`;
    }
    let i18n_33;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_33 = goog.getMsg("Millisecond");
      i18n_33 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_33;
    } else {
      i18n_33 = $localize`:kendo.timepicker.millisecond|The label for the millisecond part in the timepicker component:Millisecond`;
    }
    let i18n_34;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_34 = goog.getMsg("Dayperiod");
      i18n_34 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_34;
    } else {
      i18n_34 = $localize`:kendo.timepicker.dayperiod|The label for the dayperiod part in the timepicker component:Dayperiod`;
    }
    let i18n_35;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_35 = goog.getMsg("clear");
      i18n_35 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_35;
    } else {
...
DateTimePickerMessages.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function DateTimePickerMessages_Factory(__ngFactoryType__) {
    return (ɵDateTimePickerMessages_BaseFactory || (ɵDateTimePickerMessages_BaseFactory = ɵɵgetInheritedFactory(DateTimePickerMessages)))(__ngFactoryType__ || DateTimePickerMessages);
  };
})();
...
DateTimePickerComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_36;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_36 = goog.getMsg("Date");
      i18n_36 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_36;
    } else {
      i18n_36 = $localize`:kendo.datetimepicker.dateTab|The Date tab text in the datetimepicker popup header:Date`;
    }
    let i18n_37;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_37 = goog.getMsg("Date tab");
      i18n_37 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_37;
    } else {
    ...
    let i18n_38;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_38 = goog.getMsg("Time");
      i18n_38 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_38;
    } else {
      i18n_38 = $localize`:kendo.datetimepicker.timeTab|The Time tab text in the datetimepicker popup header:Time`;
    }
    let i18n_39;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_39 = goog.getMsg("Time tab");
      i18n_39 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_39;
    } else {
    ...
    let i18n_40;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_40 = goog.getMsg("Toggle popup");
      i18n_40 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_40;
    } else {
      i18n_40 = $localize`:kendo.datetimepicker.toggle|The title of the toggle button in the datetimepicker component:Toggle popup`;
    }
    let i18n_41;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_41 = goog.getMsg("Set");
      i18n_41 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_41;
    } else {
      i18n_41 = $localize`:kendo.datetimepicker.accept|The Accept button text in the datetimepicker component:Set`;
    }
    let i18n_42;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_42 = goog.getMsg("Set");
      i18n_42 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_42;
    } else {
      i18n_42 = $localize`:kendo.datetimepicker.acceptLabel|The label for the Accept button in the datetimepicker component:Set`;
    }
    let i18n_43;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_43 = goog.getMsg("Cancel");
      i18n_43 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_43;
    } else {
      i18n_43 = $localize`:kendo.datetimepicker.cancel|The Cancel button text in the datetimepicker component:Cancel`;
    }
    let i18n_44;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_44 = goog.getMsg("Cancel");
      i18n_44 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_44;
    } else {
      i18n_44 = $localize`:kendo.datetimepicker.cancelLabel|The label for the Cancel button in the datetimepicker component:Cancel`;
    }
    let i18n_45;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_45 = goog.getMsg("NOW");
      i18n_45 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_45;
    } else {
      i18n_45 = $localize`:kendo.datetimepicker.now|The Now button text in the timepicker component:NOW`;
    }
    let i18n_46;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_46 = goog.getMsg("Select now");
      i18n_46 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_46;
    } else {
      i18n_46 = $localize`:kendo.datetimepicker.nowLabel|The label for the Now button in the timepicker component:Select now`;
    }
    let i18n_47;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_47 = goog.getMsg("Today");
      i18n_47 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_47;
    } else {
      i18n_47 = $localize`:kendo.datetimepicker.today|The label for the today button in the calendar header:Today`;
    }
    let i18n_48;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_48 = goog.getMsg("Navigate to previous view");
      i18n_48 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_48;
    } else {
    ...
    let i18n_49;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_49 = goog.getMsg("Navigate to next view");
      i18n_49 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_49;
    } else {
    ...
    let i18n_50;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_50 = goog.getMsg("Navigate to parent view");
      i18n_50 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_50;
    } else {
    ...
    let i18n_51;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_51 = goog.getMsg("Hour");
      i18n_51 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_51;
    } else {
      i18n_51 = $localize`:kendo.datetimepicker.hour|The label for the hour part in the timepicker component:Hour`;
    }
    let i18n_52;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_52 = goog.getMsg("Minute");
      i18n_52 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_52;
    } else {
      i18n_52 = $localize`:kendo.datetimepicker.minute|The label for the minute part in the timepicker component:Minute`;
    }
    let i18n_53;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_53 = goog.getMsg("Second");
      i18n_53 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_53;
    } else {
      i18n_53 = $localize`:kendo.datetimepicker.second|The label for the second part in the timepicker component:Second`;
    }
    let i18n_54;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_54 = goog.getMsg("Millisecond");
      i18n_54 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_54;
    } else {
    ...
    let i18n_55;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_55 = goog.getMsg("Dayperiod");
      i18n_55 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_55;
    } else {
      i18n_55 = $localize`:kendo.datetimepicker.dayperiod|The label for the dayperiod part in the timepicker component:Dayperiod`;
    }
    let i18n_56;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_56 = goog.getMsg("clear");
      i18n_56 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_56;
    } else {
...
WeekNamesService.ɵfac = function WeekNamesService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || WeekNamesService)(ɵɵinject(IntlService));
};
...
DateRangePopupTemplateDirective.ɵfac = function DateRangePopupTemplateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangePopupTemplateDirective)(ɵɵdirectiveInject(TemplateRef));
};
...
DateRangeService.ɵfac = function DateRangeService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangeService)(ɵɵinject(Renderer2, 8));
};
...
DateRangeSelectionDirective.ɵfac = function DateRangeSelectionDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangeSelectionDirective)(ɵɵdirectiveInject(MultiViewCalendarComponent), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(DateRangeService, 8));
};
...
DateRangePopupMessages.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function DateRangePopupMessages_Factory(__ngFactoryType__) {
    return (ɵDateRangePopupMessages_BaseFactory || (ɵDateRangePopupMessages_BaseFactory = ɵɵgetInheritedFactory(DateRangePopupMessages)))(__ngFactoryType__ || DateRangePopupMessages);
  };
})();
...
DateRangePopupLocalizedMessagesDirective.ɵfac = function DateRangePopupLocalizedMessagesDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangePopupLocalizedMessagesDirective)(ɵɵdirectiveInject(LocalizationService));
};
...
DateRangePopupComponent.ɵfac = function DateRangePopupComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangePopupComponent)(ɵɵdirectiveInject(PopupService), ɵɵdirectiveInject(DateRangeService), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(LocalizationService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(RTL, 8));
};
DateRangePopupComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_57;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_57 = goog.getMsg("Set");
      i18n_57 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_57;
    } else {
      i18n_57 = $localize`:kendo.daterangepopup.accept|The Accept button text in the timepicker component:Set`;
    }
    let i18n_58;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_58 = goog.getMsg("Set time");
      i18n_58 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_58;
    } else {
      i18n_58 = $localize`:kendo.daterangepopup.acceptLabel|The label for the Accept button in the timepicker component:Set time`;
    }
    let i18n_59;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_59 = goog.getMsg("Cancel");
      i18n_59 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_59;
    } else {
      i18n_59 = $localize`:kendo.daterangepopup.cancel|The Cancel button text in the timepicker component:Cancel`;
    }
    let i18n_60;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_60 = goog.getMsg("Cancel changes");
      i18n_60 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_DILTECA_DILTECA_COM_WS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_DATEINPUTS_FESM2020_PROGRESS_KENDO_ANGULAR_DATEINPUTS_MJS_60;
    } else {
...
DateRangeComponent.ɵfac = function DateRangeComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangeComponent)(ɵɵdirectiveInject(DateRangeService));
};
...
DateRangeInput.ɵfac = function DateRangeInput_Factory(__ngFactoryType__) {
  ɵɵinvalidFactory();
};
...
DateRangeEndInputDirective.ɵfac = function DateRangeEndInputDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangeEndInputDirective)(ɵɵdirectiveInject(DateRangeService), ɵɵdirectiveInject(DateInputComponent), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone));
};
...
DateRangeStartInputDirective.ɵfac = function DateRangeStartInputDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangeStartInputDirective)(ɵɵdirectiveInject(DateRangeService), ɵɵdirectiveInject(DateInputComponent), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(NgZone));
};
...
DatePickerCustomMessagesComponent.ɵfac = function DatePickerCustomMessagesComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DatePickerCustomMessagesComponent)(ɵɵdirectiveInject(LocalizationService));
};
...
DateRangePopupCustomMessagesComponent.ɵfac = function DateRangePopupCustomMessagesComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangePopupCustomMessagesComponent)(ɵɵdirectiveInject(LocalizationService));
};
...
DateTimePickerCustomMessagesComponent.ɵfac = function DateTimePickerCustomMessagesComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateTimePickerCustomMessagesComponent)(ɵɵdirectiveInject(LocalizationService));
};
...
TimePickerCustomMessagesComponent.ɵfac = function TimePickerCustomMessagesComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TimePickerCustomMessagesComponent)(ɵɵdirectiveInject(LocalizationService));
};
...
var KENDO_TIMEPICKER = [TimePickerCustomMessagesComponent, TimePickerComponent];
...
CalendarsModule.ɵfac = function CalendarsModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || CalendarsModule)();
};
...
DateInputModule.ɵfac = function DateInputModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateInputModule)();
};
...
DateInputsModule.ɵfac = function DateInputsModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateInputsModule)();
};
...
TimePickerModule.ɵmod = ɵɵdefineNgModule({
  ...
  imports: [TimePickerCustomMessagesComponent, TimePickerComponent],
  exports: [TimePickerCustomMessagesComponent, TimePickerComponent]
});
...
MultiViewCalendarModule.ɵfac = function MultiViewCalendarModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MultiViewCalendarModule)();
};
...
DateRangeModule.ɵfac = function DateRangeModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || DateRangeModule)();
};
...
var KENDO_ADAPTIVE = [...KENDO_RESIZESENSOR, ...KENDO_BUTTON, ...KENDO_NAVIGATION];
var AdaptiveModule = class {
};
AdaptiveModule.ɵfac = function AdaptiveModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || AdaptiveModule)();
};
AdaptiveModule.ɵmod = ɵɵdefineNgModule({
  type: AdaptiveModule,
  imports: [ResizeSensorComponent, ButtonComponent, ActionSheetComponent, ActionSheetHeaderTemplateDirective, ActionSheetItemTemplateDirective, ActionSheetContentTemplateDirective, ActionSheetFooterTemplateDirective, ActionSheetTemplateDirective, AppBarComponent, AppBarSectionComponent, AppBarSpacerComponent, BottomNavigationComponent, BottomNavigationItemTemplateDirective, BreadCrumbComponent, BreadCrumbItemTemplateDirective],
  exports: [ResizeSensorComponent, ButtonComponent, ActionSheetComponent, ActionSheetHeaderTemplateDirective, ActionSheetItemTemplateDirective, ActionSheetContentTemplateDirective, ActionSheetFooterTemplateDirective, ActionSheetTemplateDirective, AppBarComponent, AppBarSectionComponent, AppBarSpacerComponent, BottomNavigationComponent, BottomNavigationItemTemplateDirective, BreadCrumbComponent, BreadCrumbItemTemplateDirective]
});
AdaptiveModule.ɵinj = ɵɵdefineInjector({
  providers: [ResizeBatchService, IconsService],
  imports: [ResizeSensorComponent, ButtonComponent, ActionSheetComponent, AppBarComponent, AppBarSectionComponent, AppBarSpacerComponent, BottomNavigationComponent, BreadCrumbComponent]
});
(() => {
...
//# sourceMappingURL=chunk-YHDBC3ZU.js.map
