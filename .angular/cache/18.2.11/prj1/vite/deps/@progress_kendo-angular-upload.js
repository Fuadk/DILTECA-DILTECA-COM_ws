...
UploadComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    ...
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_0 = goog.getMsg("Cancel");
      i18n_0 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_0;
    } else {
      i18n_0 = $localize`:kendo.upload.cancel|The text for the Cancel button:Cancel`;
    }
    let i18n_1;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_1 = goog.getMsg("Clear");
      i18n_1 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_1;
    } else {
      i18n_1 = $localize`:kendo.upload.clearSelectedFiles|The text for the Clear button:Clear`;
    }
    let i18n_2;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_2 = goog.getMsg("Drop files here to upload");
      i18n_2 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_2;
    } else {
      i18n_2 = $localize`:kendo.upload.dropFilesHere|The drop zone hint:Drop files here to upload`;
    }
    let i18n_3;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_3 = goog.getMsg("files");
      i18n_3 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_3;
    } else {
      i18n_3 = $localize`:kendo.upload.filesBatchStatus|The status message for a batch of files:files`;
    }
    let i18n_4;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_4 = goog.getMsg("files failed to upload.");
      i18n_4 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_4;
    } else {
    ...
    let i18n_5;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_5 = goog.getMsg("files successfully uploaded.");
      i18n_5 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_5;
    } else {
    ...
    let i18n_6;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_6 = goog.getMsg("File failed to upload.");
      i18n_6 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_6;
    } else {
      i18n_6 = $localize`:kendo.upload.fileStatusFailed|The file status message after failed upload:File failed to upload.`;
    }
    let i18n_7;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_7 = goog.getMsg("File successfully uploaded.");
      i18n_7 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_7;
    } else {
    ...
    let i18n_8;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_8 = goog.getMsg("Paused");
      i18n_8 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_8;
    } else {
      i18n_8 = $localize`:kendo.upload.headerStatusPaused|The header status message when the file upload is paused:Paused`;
    }
    let i18n_9;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_9 = goog.getMsg("Done");
      i18n_9 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_9;
    } else {
      i18n_9 = $localize`:kendo.upload.headerStatusUploaded|The header status message after file upload completion:Done`;
    }
    let i18n_10;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_10 = goog.getMsg("Uploading...");
      i18n_10 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_10;
    } else {
      i18n_10 = $localize`:kendo.upload.headerStatusUploading|The header status message during file upload:Uploading...`;
    }
    let i18n_11;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_11 = goog.getMsg("File type not allowed.");
      i18n_11 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_11;
    } else {
    ...
    let i18n_12;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_12 = goog.getMsg("File size too large.");
      i18n_12 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_12;
    } else {
    ...
    let i18n_13;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_13 = goog.getMsg("File size too small.");
      i18n_13 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_13;
    } else {
    ...
    let i18n_14;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_14 = goog.getMsg("Pause");
      i18n_14 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_14;
    } else {
      i18n_14 = $localize`:kendo.upload.pause|The text for the Pause button:Pause`;
    }
    let i18n_15;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_15 = goog.getMsg("Remove");
      i18n_15 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_15;
    } else {
      i18n_15 = $localize`:kendo.upload.remove|The text for the Remove button:Remove`;
    }
    let i18n_16;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_16 = goog.getMsg("Resume");
      i18n_16 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_16;
    } else {
      i18n_16 = $localize`:kendo.upload.resume|The text for the Resume button:Resume`;
    }
    let i18n_17;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_17 = goog.getMsg("Retry");
      i18n_17 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_17;
    } else {
      i18n_17 = $localize`:kendo.upload.retry|The text for the Retry button:Retry`;
    }
    let i18n_18;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_18 = goog.getMsg("Select files...");
      i18n_18 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_18;
    } else {
      i18n_18 = $localize`:kendo.upload.select|The text for the Select button:Select files...`;
    }
    let i18n_19;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_19 = goog.getMsg("Upload");
      i18n_19 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_19;
    } else {
...
UploadDropZoneComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_20;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_20 = goog.getMsg("Drag and drop files here to upload");
      i18n_20 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_20;
    } else {
...
FileSelectComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_21;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_21 = goog.getMsg("Drop files here to select");
      i18n_21 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_21;
    } else {
      i18n_21 = $localize`:kendo.fileselect.dropFilesHere|The drop zone hint:Drop files here to select`;
    }
    let i18n_22;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_22 = goog.getMsg("File type not allowed.");
      i18n_22 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_22;
    } else {
    ...
    let i18n_23;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_23 = goog.getMsg("File size too large.");
      i18n_23 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_23;
    } else {
    ...
    let i18n_24;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_24 = goog.getMsg("File size too small.");
      i18n_24 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_24;
    } else {
    ...
    let i18n_25;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_25 = goog.getMsg("Remove");
      i18n_25 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_25;
    } else {
      i18n_25 = $localize`:kendo.fileselect.remove|The text for the Remove button:Remove`;
    }
    let i18n_26;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_26 = goog.getMsg("Select files...");
      i18n_26 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_UPLOAD_FESM2020_PROGRESS_KENDO_ANGULAR_UPLOAD_MJS_26;
    } else {
