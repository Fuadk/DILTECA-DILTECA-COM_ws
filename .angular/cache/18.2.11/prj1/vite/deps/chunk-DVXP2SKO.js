...
FloatingLabelComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    ...
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LABEL_FESM2020_PROGRESS_KENDO_ANGULAR_LABEL_MJS_0 = goog.getMsg("Optional");
      i18n_0 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LABEL_FESM2020_PROGRESS_KENDO_ANGULAR_LABEL_MJS_0;
    } else {
...
LabelComponent.ɵcmp = ɵɵdefineComponent({
  ...
  consts: () => {
    let i18n_1;
    if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
      const MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LABEL_FESM2020_PROGRESS_KENDO_ANGULAR_LABEL_MJS_1 = goog.getMsg("Optional");
      i18n_1 = MSG__USERS_MACBOOKPRO_DOCUMENTS_WIN_GENOVITY_DEV_USERS_USERTEMP_USERWS_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LABEL_FESM2020_PROGRESS_KENDO_ANGULAR_LABEL_MJS_1;
    } else {
...
//# sourceMappingURL=chunk-DVXP2SKO.js.map
