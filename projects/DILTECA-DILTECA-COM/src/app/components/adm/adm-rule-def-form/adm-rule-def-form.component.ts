...
public userLang = "EN" ; 
public lookupArrDef =[	{"statment":"select CHOICE CODE, TEXT CODETEXT_LANG from MENUS m where MENU  in ('APPS','MAIN') order by CODETEXT_LANG ",
      "lkpArrName":"lkpArrMODULE"},
      {"statment":"SELECT CODE, CODETEXT_LANG, CODEVALUE_LANG FROM SOM_TABS_CODES WHERE CODENAME ='RULE_TRIGGER'  order by CODETEXT_LANG",
