...
import { actruleDefAccountabilityActRuleDefForm , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-accountability-act-rule-def-form',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './accountability-act-rule-def-form.component.html',
  styleUrls: ['./accountability-act-rule-def-form.component.scss']
})


export class ActRuleDefAccountabilityActRuleDefFormFormComponent {
  public title =  this.starServices.getNLS([],"accountability_ACT_RULE_DEF_FORM.actruleDefAccountabilityActRuleDefForm.component_title","Act Rule Def Accountability Act Rule Def Form");
  public routineName = "ActRuleDefAccountabilityActRuleDefFormForm";
  private insertCMD = "INSERT_ACT_RULE_DEF";
  private updateCMD = "UPDATE_ACT_RULE_DEF";
  private deleteCMD =   "DELETE_ACT_RULE_DEF";
  private getCMD = "GET_ACT_RULE_DEF_QUERY";
  ...
  public primarKeyReadOnlyArr = {isRULE_IDreadOnly : false};  
  public paramConfig;
...
public compSelector = 'app-accountability-act-rule-def-form';
...
this.form = createFormGroup(
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new actruleDefAccountabilityActRuleDefForm();   
    @Input() public set detail_Input(form: any) {
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ActRuleDefAccountabilityActRuleDefFormForm form.RULE_ID :' + form.RULE_ID);
...
this.form.get('RULE_DESCRIPTION').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ActRuleDefAccountabilityActRuleDefFormForm ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_RULE_DESCRIPTION(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.form.controls['RULE_DESCRIPTION'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.form.get('RULE_DESCRIPTION').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_LOGDATE(value) {
 ...
 async onChange_DISABLED(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 ...
 async onChange_RULE_DESCRIPTION(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_RULE_DESCRIPTION(value); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
