...
import { actruleActionAccountabilityActRuleActionForm , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-accountability-act-rule-action-form',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './accountability-act-rule-action-form.component.html',
  styleUrls: ['./accountability-act-rule-action-form.component.scss']
})


export class ActRuleActionAccountabilityActRuleActionFormFormComponent {
  public title =  this.starServices.getNLS([],"accountability_ACT_RULE_ACTION_FORM.actruleActionAccountabilityActRuleActionForm.component_title","Act Rule Action Accountability Act Rule Action Form");
  public routineName = "ActRuleActionAccountabilityActRuleActionFormForm";
...
public compSelector = 'app-accountability-act-rule-action-form';
...
this.form = createFormGroup(
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new actruleActionAccountabilityActRuleActionForm();   
    @Input() public set detail_Input(form: any) {
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ActRuleActionAccountabilityActRuleActionFormForm form.RULE_ID :' + form.RULE_ID);
...
this.lookupArrDef =[	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"ACT_ACTION_CODE\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrACTION_CODE"},
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"DISABLED\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
...
this.form.get('ACTION_ID').valueChanges.subscribe(val => {
});
this.form.get('ACTION_ORDER').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ActRuleActionAccountabilityActRuleActionFormForm ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_ACTION_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.form.controls['ACTION_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.form.get('ACTION_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }
async WHEN_VALIDATE_ITEM_ACTION_ORDER(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.form.controls['ACTION_ORDER'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.form.get('ACTION_ORDER').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }
async WHEN_VALIDATE_ITEM_ACTION_CODE(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.form.controls['ACTION_CODE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.form.get('ACTION_CODE').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_LOGDATE(value) {
 ...
 async onChange_ACTION_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_ACTION_ID(value); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onChange_ACTION_ORDER(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_ACTION_ORDER(value); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onValueChange_ACTION_CODE(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_ACTION_CODE(value); if ( this.FORM_TRIGGER_FAILURE) return;  
  } 
