...
@Component({
  selector: 'app-accountability-act-payment-grid',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './accountability-act-payment-grid.component.html',
  styleUrls: ['./accountability-act-payment-grid.component.scss'
],
...
export class ActPaymentAccountabilityActPaymentGridGridComponent implements OnInit,OnDestroy {
...
public  isPAYMENT_NUMBEREnable : boolean = true; 
  ...
  public title =  this.starServices.getNLS([],"accountability_ACT_PAYMENT_GRID.actpaymentAccountabilityActPaymentGrid.component_title","Act Payment Accountability Act Payment Grid");
...
public compSelector = 'app-accountability-act-payment-grid';
...
//Next part for filtering
  ...
  private gridInitialValues:any = new actpaymentAccountabilityActPaymentGrid();   
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ActPaymentAccountabilityActPaymentGridGrid ComponentConfig:", ComponentConfig);
