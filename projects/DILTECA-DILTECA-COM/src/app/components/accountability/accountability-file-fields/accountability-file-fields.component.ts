...
@Component({
  ...
  selector: 'app-accountability-file-fields',
  templateUrl: './accountability-file-fields.component.html',
  styleUrls: ['./accountability-file-fields.component.scss']
})
export class AccountabilityFileFieldsComponent implements OnInit {
  ...
  this.title =  this.starServices.getNLS([],"accountability_file_fields.accountability_file_fields.component_title","Act File Def Act File Def Form");
  ...
  public paramConfig; 
  public title = '';
  public routineName = "accountability_file_fields";
  ...
  public routineAuth = "AccountabilityFileFields";
  ...
  ngOnInit(): void {
   ...
   this.ACT_PAYMENTGrid_2Config.gridHeight = "300";
    ...
    public readCompletedHandler( form_ACT_FILE_DEF) {
      console.log("readCompletedHandler:", form_ACT_FILE_DEF)
      if (form_ACT_FILE_DEF.FILE_TYPE == "INVOICE")
        this.selectedTab = 2;
      if (form_ACT_FILE_DEF.FILE_TYPE == "PAYMENT")
        this.selectedTab = 3;
