...
import {   actfileDefAccountabilityActFileDefGrid , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-accountability-act-file-def-grid',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './accountability-act-file-def-grid.component.html',
  styleUrls: ['./accountability-act-file-def-grid.component.scss'
],
...
export class ActFileDefAccountabilityActFileDefGridGridComponent implements OnInit,OnDestroy {
...
public  isFILE_NAMEEnable : boolean = true; 
  ...
  public title =  this.starServices.getNLS([],"accountability_ACT_FILE_DEF_GRID.actfileDefAccountabilityActFileDefGrid.component_title","Act File Def Accountability Act File Def Grid");
...
public compSelector = 'app-accountability-act-file-def-grid';
...
//Next part for filtering
  ...
  private gridInitialValues:any = new actfileDefAccountabilityActFileDefGrid();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['FILE_TYPE'],data['FILE_NAME']];
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ActFileDefAccountabilityActFileDefGridGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_DOC_NAME(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.formGroup.controls['DOC_NAME'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.formGroup.get('DOC_NAME').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
async WHEN_VALIDATE_ITEM_SEPARATOR(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.formGroup.controls['SEPARATOR'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.formGroup.get('SEPARATOR').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
async WHEN_VALIDATE_ITEM_DOC_INFO(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.formGroup.controls['DOC_INFO'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.formGroup.get('DOC_INFO').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_LOG_DATE(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.formGroup.controls['LOG_DATE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.formGroup.get('LOG_DATE').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 } 
 ...
 async onBlur_DOC_NAME() { 
  await this.WHEN_VALIDATE_ITEM_DOC_NAME(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_SEPARATOR() { 
  await this.WHEN_VALIDATE_ITEM_SEPARATOR(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_DOC_INFO() { 
  await this.WHEN_VALIDATE_ITEM_DOC_INFO(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_LOGNAME() { 
  await this.WHEN_VALIDATE_ITEM_LOGNAME(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async valueChangeLOG_DATE(value: any) { 
 await this.WHEN_VALIDATE_ITEM_LOG_DATE(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 }
