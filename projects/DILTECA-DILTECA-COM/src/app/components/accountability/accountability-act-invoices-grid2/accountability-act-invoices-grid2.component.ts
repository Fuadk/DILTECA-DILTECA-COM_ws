...
import {   actinvoicesAccountabilityActInvoicesGrid2 , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-accountability-act-invoices-grid2',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './accountability-act-invoices-grid2.component.html',
  styleUrls: ['./accountability-act-invoices-grid2.component.scss'
],
...
export class ActInvoicesAccountabilityActInvoicesGrid2GridComponent implements OnInit,OnDestroy {
...
public  isINVOICE_NUMBEREnable : boolean = true; 
  ...
  public title =  this.starServices.getNLS([],"accountability_ACT_INVOICES_GRID2.actinvoicesAccountabilityActInvoicesGrid2.component_title","Act Invoices Accountability Act Invoices Grid2");
...
public compSelector = 'app-accountability-act-invoices-grid2';
...
//Next part for filtering
  ...
  @Input() public set detail_Input(grid: any) {
    ...
    else
    {
      ...
      if (typeof this.grid2 != "undefined")
      {
        //this.isChild = false;
        this.grid2.data = null;
        this.masterKey = "";
  ...
  private gridInitialValues:any = new actinvoicesAccountabilityActInvoicesGrid2();   
 ...
 async cellClickHandler(event:any ) {
    ...
    if (this.componentConfig.enabled && this.componentConfig.updateable) {
      ...
      this.grid2.editRow(event.rowIndex, this.formGroup);
    }
  ...
  public enterQuery (grid : GridComponent): void{
   ...
   async callBackFunction(data:any) {
      ...
      let GridData:any;
      GridData = Object.assign([], this.grid2.data);
  ...
  private closeEditor(): void {
    //this.starServices.closeEditor_grid( this, this.grid2);
  }
...
public saveCurrent() {
  ...
  //this.starServices.saveCurrent_grid( this, this.grid2);
  return true;
}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ActInvoicesAccountabilityActInvoicesGrid2Grid ComponentConfig:", ComponentConfig);
