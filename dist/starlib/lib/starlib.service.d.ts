...
export declare class starServices extends BehaviorSubject<GridDataResult> {
    ...
    getUserInfo(object: any, user: any): void;
    rulesPostQueryDef: {
        rulePtrsArr: any[];
        rulesArr: any[];
        actionPtrsArr: any[];
    ...
    checkRulesByTrigger(object: any, rulesDef: any, queryData: any, Trigger: any, routine_name: any, hostsArr: any, hostsMapArr: any): any;
